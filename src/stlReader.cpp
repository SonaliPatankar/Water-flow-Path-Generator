...
IOOperation::StlReader::StlReader() {}
IOOperation::StlReader::~StlReader() {}

void IOOperation::StlReader::read(const std::string& filePath, Geometry::Triangulation& triangulation)
{
    ...
    while (getline(file, line))
    {
        ...
        if (line.find("vertex") != std::string::npos)
        {
            ...
            if (iterator == pointIndexMap.end())
            {
                ...
                triangulation.addUniquePoint(point);
            }
